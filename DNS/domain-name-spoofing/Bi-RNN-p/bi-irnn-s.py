...
def build_model(data_shape):                                                                                                                   
    ...
    model.add(Bidirectional(SimpleRNN(128,kernel_initializer=initializers.RandomNormal(stddev=0.001),recurrent_initializer=initializers.Identity(gain=1.0),activation='relu')))
