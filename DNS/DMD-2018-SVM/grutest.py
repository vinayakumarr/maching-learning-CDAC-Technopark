...
model_feat = Model(inputs=model.input,outputs=model.get_layer('gru_1').output)
...
np.savetxt('gcna/expected.txt', y_train1, fmt='%01d')
np.savetxt('gcna/LR-predicted.txt', y_pred, fmt='%01d')
...
np.savetxt('gcna/expected1.txt', y_testv, fmt='%01d')
np.savetxt('gcna/LR-predicted1.txt', y_pred1, fmt='%01d')
...
precision = precision_score(y_train1, y_pred , average="weighted")
f1 = f1_score(y_train1, y_pred, average="weighted")
np.savetxt('gcna/NB-predicted.txt', y_pred, fmt='%01d')
...
np.savetxt('gcna/NB-predicted1.txt', y_pred1, fmt='%01d')
...
precision = precision_score(y_train1, y_pred , average="weighted")
f1 = f1_score(y_train1, y_pred, average="weighted")
np.savetxt('gcna/KNN-predicted.txt', y_pred, fmt='%01d')
...
precision1 = precision_score(y_testv, y_pred1, average="weighted")
f11 = f1_score(y_testv, y_pred1, average="weighted")
np.savetxt('gcna/KNN-predicted1.txt', y_pred1, fmt='%01d')
...
precision = precision_score(y_train1, y_pred , average="weighted")
f1 = f1_score(y_train1, y_pred, average="weighted")
np.savetxt('gcna/DT-predicted.txt', y_pred, fmt='%01d')
...
precision1 = precision_score(y_testv, y_pred1, average="weighted")
f11 = f1_score(y_testv, y_pred1, average="weighted")
np.savetxt('gcna/DT-predicted1.txt', y_pred1, fmt='%01d')
...
precision = precision_score(y_train1, y_pred , average="weighted")
f1 = f1_score(y_train1, y_pred, average="weighted")
np.savetxt('gcna/RF-predicted.txt', y_pred, fmt='%01d')
...
precision1 = precision_score(y_testv, y_pred1, average="weighted")
f11 = f1_score(y_testv, y_pred1, average="weighted")
np.savetxt('gcna/RF-predicted1.txt', y_pred1, fmt='%01d')
...
precision = precision_score(y_train1, y_pred , average="weighted")
f1 = f1_score(y_train1, y_pred, average="weighted")
np.savetxt('gcna/SVM-rbf-predicted.txt', y_pred, fmt='%01d')
...
precision1 = precision_score(y_testv, y_pred1, average="weighted")
f11 = f1_score(y_testv, y_pred1, average="weighted")
np.savetxt('gcna/SVM-rbf-predicted1.txt', y_pred1, fmt='%01d')
...
precision = precision_score(y_train1, y_pred , average="weighted")
f1 = f1_score(y_train1, y_pred, average="weighted")
np.savetxt('gcna/SVM-linear-predicted.txt', y_pred, fmt='%01d')
...
precision1 = precision_score(y_testv, y_pred1, average="weighted")
f11 = f1_score(y_testv, y_pred1, average="weighted")
np.savetxt('gcna/SVM-linear-predicted1.txt', y_pred1, fmt='%01d')
