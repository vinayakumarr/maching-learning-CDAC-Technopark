...
model_feat = Model(inputs=model.input,outputs=model.get_layer('simple_rnn_1').output)
...
np.savetxt('rcna/expected.txt', y_train1, fmt='%01d')
np.savetxt('rcna/LR-predicted.txt', y_pred, fmt='%01d')
...
np.savetxt('rcna/expected1.txt', y_testv, fmt='%01d')
np.savetxt('rcna/LR-predicted1.txt', y_pred1, fmt='%01d')
...
precision = precision_score(y_train1, y_pred , average="weighted")
f1 = f1_score(y_train1, y_pred, average="weighted")
np.savetxt('rcna/NB-predicted.txt', y_pred, fmt='%01d')
...
np.savetxt('rcna/NB-predicted1.txt', y_pred1, fmt='%01d')
...
precision = precision_score(y_train1, y_pred , average="weighted")
f1 = f1_score(y_train1, y_pred, average="weighted")
np.savetxt('rcna/KNN-predicted.txt', y_pred, fmt='%01d')
...
precision1 = precision_score(y_testv, y_pred1, average="weighted")
f11 = f1_score(y_testv, y_pred1, average="weighted")
np.savetxt('rcna/KNN-predicted1.txt', y_pred1, fmt='%01d')
...
precision = precision_score(y_train1, y_pred , average="weighted")
f1 = f1_score(y_train1, y_pred, average="weighted")
np.savetxt('rcna/DT-predicted.txt', y_pred, fmt='%01d')
...
precision1 = precision_score(y_testv, y_pred1, average="weighted")
f11 = f1_score(y_testv, y_pred1, average="weighted")
np.savetxt('rcna/DT-predicted1.txt', y_pred1, fmt='%01d')
...
precision = precision_score(y_train1, y_pred , average="weighted")
f1 = f1_score(y_train1, y_pred, average="weighted")
np.savetxt('rcna/RF-predicted.txt', y_pred, fmt='%01d')
...
precision1 = precision_score(y_testv, y_pred1, average="weighted")
f11 = f1_score(y_testv, y_pred1, average="weighted")
np.savetxt('rcna/RF-predicted1.txt', y_pred1, fmt='%01d')
...
precision = precision_score(y_train1, y_pred , average="weighted")
f1 = f1_score(y_train1, y_pred, average="weighted")
np.savetxt('rcna/SVM-rbf-predicted.txt', y_pred, fmt='%01d')
...
precision1 = precision_score(y_testv, y_pred1, average="weighted")
f11 = f1_score(y_testv, y_pred1, average="weighted")
np.savetxt('rcna/SVM-rbf-predicted1.txt', y_pred1, fmt='%01d')
...
precision = precision_score(y_train1, y_pred , average="weighted")
f1 = f1_score(y_train1, y_pred, average="weighted")
np.savetxt('rcna/SVM-linear-predicted.txt', y_pred, fmt='%01d')
...
precision1 = precision_score(y_testv, y_pred1, average="weighted")
f11 = f1_score(y_testv, y_pred1, average="weighted")
np.savetxt('rcna/SVM-linear-predicted1.txt', y_pred1, fmt='%01d')
...
np.savetxt("res/rnn1.txt",y_pred, fmt="%01d")


y_pred = model.predict_classes(X_test1)
np.savetxt("res/rnn2.txt",y_pred, fmt="%01d")
