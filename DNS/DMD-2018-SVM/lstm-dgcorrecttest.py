...
precision = precision_score(y_train1, y_pred , average="weighted")
f1 = f1_score(y_train1, y_pred, average="weighted")
np.savetxt('lcna/RF-predicted.txt', y_pred, fmt='%01d')
...
precision1 = precision_score(y_testv, y_pred1, average="weighted")
f11 = f1_score(y_testv, y_pred1, average="weighted")
np.savetxt('lcna/RF-predicted1.txt', y_pred1, fmt='%01d')
...
precision = precision_score(y_train1, y_pred , average="weighted")
f1 = f1_score(y_train1, y_pred, average="weighted")
np.savetxt('lcna/SVM-rbf-predicted.txt', y_pred, fmt='%01d')
...
precision1 = precision_score(y_testv, y_pred1, average="weighted")
f11 = f1_score(y_testv, y_pred1, average="weighted")
np.savetxt('lcna/SVM-rbf-predicted1.txt', y_pred1, fmt='%01d')
...
precision = precision_score(y_train1, y_pred , average="weighted")
f1 = f1_score(y_train1, y_pred, average="weighted")
np.savetxt('lcna/SVM-linear-predicted.txt', y_pred, fmt='%01d')
...
precision1 = precision_score(y_testv, y_pred1, average="weighted")
f11 = f1_score(y_testv, y_pred1, average="weighted")
np.savetxt('lcna/SVM-linear-predicted1.txt', y_pred1, fmt='%01d')
...
np.savetxt("res/lstm1.txt",y_pred, fmt="%01d")


y_pred = model.predict_classes(X_test1)
np.savetxt("res/lstm2.txt",y_pred, fmt="%01d")
