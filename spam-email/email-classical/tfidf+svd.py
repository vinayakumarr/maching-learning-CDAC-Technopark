...
X_train = Featurelearning(Traindata, Method="SVD")
y_train = datalabel
...
np.savetxt('res/predicted_LR_TFIDF+svd.txt', proba)
...
predicted = model.predict(X_test)
proba = model.predict_proba(X_test)
np.savetxt('res/predicted_NB_TFIDF+svd.txt', proba)
...
predicted = model.predict(X_test)
proba = model.predict_proba(X_test)
np.savetxt('res/predicted_KNN_TFIDF+svd.txt', proba)
...
predicted = model.predict(X_test)
proba = model.predict_proba(X_test)
np.savetxt('res/predicted_DT_TFIDF+svd.txt', proba)
...
predicted = model.predict(X_test)
proba = model.predict_proba(X_test)
np.savetxt('res/predicted_AB_TFIDF+svd.txt', proba)
...
predicted = model.predict(X_test)
proba = model.predict_proba(X_test)
np.savetxt('res/predicted_RF_TFIDF+svd.txt', proba)
...
predicted = model.predict(X_test)
proba = model.predict_proba(X_test)
np.savetxt('res/predicted_SVM-linear_TFIDF+svd.txt', proba)
...
predicted = model.predict(X_test)
proba = model.predict_proba(X_test)
np.savetxt('res/predicted_SVM-rbf_TFIDF+svd.txt', proba)
